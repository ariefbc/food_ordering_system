...
<html>
  <head>
    ...
    <script>
    var markers = [['Pacific Place',-6.224309,106.8098351],['CIMB Niaga',-6.225034,106.8057162],['FX Sudirman',-6.2245804,106.8040181],['Plaza Senayan',-6.225573,106.7991614]];
      function gmap_initialize() {
        var mapOptions = {
          center: new google.maps.LatLng(-6.224309,106.8098351),
          zoom: 17,
  ...
  <body class="skin-yellow fixed sidebar-collapse" data-spy="scroll" data-target="#scrollspy">
    <div class="wrapper">
      ...
      <footer class="main-footer">
        ...
        developed by <strong>@r!3f</strong> - 2016
      </footer>
    </div><!-- ./wrapper -->
