...
<html>
  ...
  <body class="skin-yellow fixed" data-spy="scroll" data-target="#scrollspy">
    <div class="wrapper">
    ...
    <script src="<?php echo base_url();?>assets/js/custom.js"></script>
     ...
     <script>
      ...
      function btn_response() {       
            setTimeout(function () { $('#div_button_panel').text('Please wait while data sync is being processed.....'); }, 0);
        }
    </script>
  </body>
</html>
