...
abstract class REST_Controller extends CI_Controller {
     ...
     */
    private function _get_default_output_format()
    {
     ...
     * @return string
     */
    private function _xss_clean($value, $xss_clean)
    {
     ...
     * @return bool
     */
    private function _check_login($username = NULL, $password = FALSE)
    {
        if (empty($username))
        {
            return FALSE;
     ...
     * @return void
     */
    private function _check_php_session()
    {
     ...
     * @return bool TRUE log table updated; otherwise, FALSE
     */
    private function _log_response_code($http_code)
    {
        if($this->_insert_id == ''){
            return false;
        }
