...
class Content_chdlang {
    ...
    public function load_content($language,$control_name,$language_options,$msgerror)
    {	
                ...
                ".form_open($control_name.'/process', array('role'=>'form','name'=>'eform'))."
                  <div class=\"box-body\">
                    <div class=\"form-group\">
                      <label for=\"language\">".$this->check_vocab($language,"Choose Language Country")."</label><br>
                      ".form_dropdown('language', $language_options['language_list'], $language_options['selected'])."
                    </div>
                    </div><!-- /.box-body -->
					<div class=\"box-footer\">
                    <button type=\"submit\" class=\"btn bg-orange\"><i class=\"fa fa-floppy-o\" aria-hidden=\"true\"></i>&nbsp;".$this->check_vocab($language,"Change Language")."</button>&nbsp;".$msgerror."
                  </div>
                </form>
              </div><!-- /.box -->";
		return $contents;
	...
	function content_header($language){
		$content_header = "<h1>".$this->check_vocab($language,"Change Language")."</h1>";
		return $content_header;	
	}
	
	function breadcrumb($language){
		$breadcrumb = "<li>".$this->check_vocab($language,"My Profile")."</li>
            <li>".$this->check_vocab($language,"Change Language")."</li>";
		return $breadcrumb;	
	}
}